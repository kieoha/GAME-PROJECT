...
def introduction():
    ...
    d = int(input("В какой внеучебный клуб зотите записаться? фехтовальный клуб / театральный кружок (1, 2)"))
    if a == 1:
    ...
    if d == 1:
        player.extra_curr = fencing
    else:
        player.extra_curr = theatre
